...
class _UserProfileState extends State<UserProfile> {
  ...
  late List<Complaint?> _futureComplaintModel;
  ...
  Widget build(BuildContext context) {
    ...
    String totalTrashBinFillCount = userModel.totalTrashBinFillCount.toString();
    ...
    List<Complaint?> complaintModels = _futureComplaintModel;
          ...
          Padding(
            ...
            child: IconButton(
              onPressed: () async {
                ...
                if (result != null) {
                  setState(() {
                    image = NetworkImage(result['displayPictureImagePath']);
